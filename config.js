...
const CONFIG = {
  ...
  DEFAULT_PREORDERS: [
    {
      id: 'PO-20260914-001',
      preorderId: 'PO-20260914-001',
      createdAt: new Date().toISOString(),
      supplierName: 'Pop Mart Official (Tmall China โกดังเซินเจิ้น)',
      customerName: 'Pop Mart Official (Tmall China โกดังเซินเจิ้น)',
      supplierContact: 'WeChat: popmart_b2b / ชิปปิ้ง FastCargo',
      customerContact: 'WeChat: popmart_b2b / ชิปปิ้ง FastCargo',
      productId: 'TOY-001',
      productName: 'กล่องสุ่ม Art Toy Baby Three V3 (ยกลัง 12 บ็อกซ์)',
      category: 'Art Toy / กล่องสุ่ม',
      quantity: 12,
      costPrice: 290,
      salePrice: 490,
      ...
      expectedArrival: '28/09/2026',
      expectedDate: '28/09/2026',
      trackingNo: 'SF-EXPRESS-99281',
      operator: 'Admin',
      note: 'มัดจำ 50% แล้ว ของเข้าพร้อมตรวจรับ'
    },
    {
      id: 'PO-20260914-002',
      preorderId: 'PO-20260914-002',
      createdAt: new Date(Date.now() - 86400000).toISOString(),
      supplierName: 'ร้านส่งสำเพ็ง เฮียเกียรติทอยส์',
      customerName: 'ร้านส่งสำเพ็ง เฮียเกียรติทอยส์',
      supplierContact: 'LINE: @kiat_toys / 081-992-8811',
      customerContact: 'LINE: @kiat_toys / 081-992-8811',
      productId: 'TOY-004',
      productName: 'พวงกุญแจ Labubu The Monsters ขนนุ่มฟู (งานกระแส)',
      category: 'ของเล่นกระแส / สำเพ็ง',
      quantity: 50,
      ...
      trackingNo: 'KERRY-BKK-44102',
      operator: 'Staff A',
      note: 'จ่ายครบแล้ว กล่องพัสดุถึงร้านแล้ว รอตรวจนับเข้าคลัง'
    }
  ]
};
